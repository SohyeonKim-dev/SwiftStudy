...
/* 오류처리
 ...
 Error 프로토콜은 사실상 요구사항이 없는 빈 프로토콜일 뿐이지만,
 오류를 표현하기 위한 타입(주로 열거형)은 이 프로토콜을 채택합니다.
 // 이거 파이썬 했을때 기플밍에서 배웠던거랑 비슷한거같음 try - catch
...
/*
 ...
 Error 프로토콜과 (주로)열거형을 통해서 오류를 표현합니다 : oh-ho..
 ...
 */
 ...
 class VendingMachine {
     ...
     func receiveMoney(_ money: Int) throws {
         ...
         // 입력한 돈이 0이하면 오류를 던집니다 : 이런 방식으로 guard를 쓰는구만!
         guard money > 0 else {
             throw VendingMachineError.invalidInput
             // 여기로 보내버리는 거임 : like return
         }
...
/*
 ...
 사용자에게 오류를 알리고 사용자에게 선택 권한을 넘겨주어 다음에 어떤 동작을 하게 할 것인지
 결정하도록 유도하는 등의 코드를 작성해야 합니다. (oh-ho..)
...
// 딱히 케이스별로 오류처리 할 필요가 없으면 do 구문만 써도 무방합니다 -> ㅋ,ㅋ 갈수록 귀차니즘,, ㅋㅌㅋ
